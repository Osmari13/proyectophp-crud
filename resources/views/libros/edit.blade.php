            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                *{{$message}}
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                    <textarea  name="descripcion" rows="3"  class="block w-full rounded-md border-0 py-1.5 bg-white pl-1 text-gray-900 shadow-sm ring-1 ring-inset ring-white-300  focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{old('descripcion', $libro->descripcion)}}</textarea>
                    </div>
                </div>
